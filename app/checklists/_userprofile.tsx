...
export function UserProfile({editOpen, sheetData, session, handleCloseSheet}:Props) {
          ...
          <SheetContent className="sm:max-w-[600px]">
            ...
            <div className="mt-4">
                <div className="flex flex-col">
                  ...
                  {session?.user?.role===1 && <div className="mt-3">
            ...
            <SheetTitle onClick={() => setShowSecurity(prev => !prev)} className="mt-6 z-50 text-slate-700 flex items-center hover:text-slate-800 cursor-pointer">
              Security
